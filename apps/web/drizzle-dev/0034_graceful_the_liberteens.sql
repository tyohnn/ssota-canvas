...
CREATE TYPE "public"."block_type" AS ENUM('text', 'shape', 'markdown', 'youtube', 'image', 'pdf', 'audio', 'video', 'file', 'python', 'link', 'page_mention', 'latex', 'github_pr', 'react_component');--> statement-breakpoint
