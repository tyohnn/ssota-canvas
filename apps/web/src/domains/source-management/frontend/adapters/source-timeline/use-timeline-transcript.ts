...
import type { TimelineTranscriptRuntimeDeps } from '@/domains/source-management/frontend/adapters/contracts/runtime-deps';
...
export function useTimelineTranscript(
  ...
  }: UseTimelineTranscriptParams,
  deps: TimelineTranscriptRuntimeDeps
): UseTimelineTranscriptResult {
  ...
  const { readonly, getBlockInteractions, updateBlockContent } = deps;
