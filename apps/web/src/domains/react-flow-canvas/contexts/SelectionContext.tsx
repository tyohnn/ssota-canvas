...
export type SelectionAction =
  ...
  | { type: 'SET_DRAG_SELECTION'; payload: Partial<DragSelectionState> }
...
export interface SelectionCommands {
  ...
  clearSelection: () => void;
  setDragSelection: (dragSelection: Partial<DragSelectionState>) => void;
...
export function SelectionProvider({
  ...
  const commands: SelectionCommands = {
    ...
    setDragSelection: useCallback((dragSelection: Partial<DragSelectionState>) => {
      dispatch({ type: 'SET_DRAG_SELECTION', payload: dragSelection });
    }, []),
...
export function useSingleNodeSelection() {
  const { state } = useSelection();
  return {
...
export function useSingleEdgeSelection() {
  const { state } = useSelection();
  return {
