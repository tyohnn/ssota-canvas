...
export function useReactFlowHandler(options: UseReactFlowHandlerOptions = {}): UseReactFlowHandlerResult {
  ...
  const { selectNodes, selectEdges, clearSelection } = useReactFlowSelectionCommands();
  ...
  const onDrop = useCallback(
    async (event: React.DragEvent) => {
      ...
      // 블록 생성
      const result = await nodeCommands.createNode(selectedPageId, blockKind, position);
