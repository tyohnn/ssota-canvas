...
export type OrganizationManagementErrorCode =
  ...
  | 'INVITATION_ACCEPTANCE_FAILED' // v1.2
...
> = {
  ...
  INVITATION_ACCEPTANCE_FAILED: '초대 수락에 실패했습니다.', // v1.2
  ...
  WORKSPACE_SERVICE_NOT_INITIALIZED:
    '워크스페이스 서비스가 초기화되지 않았습니다.',
  DEFAULT_ORGANIZATION_ALREADY_EXISTS: '기본 조직이 이미 존재합니다.',
};
