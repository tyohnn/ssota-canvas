 ...
 */
export const softDeleteBlockMountAction = withSecureAction(
  SoftDeleteBlockMountRequestSchema,
  {
    getPageId: req => req.pageId,
    actionName: 'softDeleteBlockMountAction',
...
async function softDeleteBlockMountInternal(
  ...
  try {
    ...
    const enrichedDto: SoftDeleteBlockMountRequest & {
      userId: string;
    } = {
      ...safeDto,
    ...
    const result =
      await canvasBlockMountService.softDeleteBlockMount(enrichedDto);
