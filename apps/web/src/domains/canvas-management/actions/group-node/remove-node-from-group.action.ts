 ...
 */
export const removeNodeFromGroupAction = withPageSecureAction(
  RemoveNodeFromGroupRequestSchema,
...
async function removeNodeFromGroupInternal(
  safeDto: RemoveNodeFromGroupRequest, // ✅ 이미 검증됨 (SafeDTO)
  ...
  try {
    ...
    const result = await removeNodeFromGroup(safeDto, blockMountRepository);
