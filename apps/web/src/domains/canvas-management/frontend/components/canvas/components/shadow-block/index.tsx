...
import type { ShadowBlockContainerProps } from './core/types';
 ...
 */
export function ShadowBlockContainer(props: ShadowBlockContainerProps) {
  const { isVisible, renderInfo, blockInfo } = useShadowBlock(props);
