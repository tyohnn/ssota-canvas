...
export type UseBlockCanvasOperationsParams = {
  reactFlow: ReactFlowDependencies;
};

export type UseBlockCanvasOperationsResult = {
  addBlockToCanvas: (
    blockId: string,
 ...
 * - TanStack Query 사용 X
 */
export function useBlockCanvasOperations(
  params: UseBlockCanvasOperationsParams
): UseBlockCanvasOperationsResult {
