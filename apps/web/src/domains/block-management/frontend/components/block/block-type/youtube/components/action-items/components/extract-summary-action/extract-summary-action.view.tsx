/**
 * Extract Summary Action View
 * 
 * Presentational component for Extract Summary Action
 */
...
export interface ExtractSummaryActionViewProps {
...
export function ExtractSummaryActionView({
  isPopoverOpen,
  onPopoverOpenChange,
  icon,
  tooltip,
