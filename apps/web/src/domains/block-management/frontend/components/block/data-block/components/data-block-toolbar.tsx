/**
 * Data Block Toolbar Component
 *
 * 블록 상단 우측에 표시되는 툴바 버튼들 (더보기, 보기 방식 변경, 에디터 열기)
 */
...
export interface DataBlockToolbarProps {
  data: BlockNodeData;
  selected: boolean;
...
export function DataBlockToolbar({
  data,
  selected,
  viewMode,
  onViewModeChange,
  ...
  return (
    <Box
      className={cn(
        'absolute top-[-45px] right-0 z-50',
        'pointer-events-auto',
        'nodrag',
        className
      )}
