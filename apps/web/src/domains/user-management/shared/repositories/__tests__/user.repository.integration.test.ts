...
class MockUserRepository implements UserRepository {
  ...
  async findById(userId: import('../../value-objects/ids.vo').UserId): Promise<UserAggregate | null> {
    // Mock implementation that calls Supabase client
    this.supabase.from();
    return null;
  }

  async findByEmail(email: import('../../value-objects/user-email.vo').UserEmail): Promise<UserAggregate | null> {
    // Mock implementation that calls Supabase client
    this.supabase.from();
    return null;
  }

  async delete(userId: import('../../value-objects/ids.vo').UserId): Promise<void> {
    // Mock implementation that calls Supabase client
    this.supabase.from();
  }
}
