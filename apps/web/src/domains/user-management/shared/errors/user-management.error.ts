...
> = {
  ...
  DEFAULT_WORKSPACE_NOT_FOUND: '기본 워크스페이스를 찾을 수 없습니다.',
  FIRST_PAGE_NOT_FOUND: '기본 워크스페이스의 첫 페이지를 찾을 수 없습니다.',
  ORGANIZATION_PAYLOAD_FAILED: '기본 조직 정보를 가져오지 못했습니다.',
  DEFAULT_ORGANIZATION_FETCH_FAILED: '기본 조직 정보를 가져오지 못했습니다.',
