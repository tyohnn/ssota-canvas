...
export interface ColorDefinition {
  ...
  tailwind: {
    ...
    outline: string; // e.g., "outline-blue-300"
  };
...
export class ShapePolicy {
  ...
  /**
   * Get border color for a color
   */
  static getTailwindBorderColor(colorKey: ColorKey): string {
    const color = this.getColorDefinition(colorKey);
    return color.tailwind.border;
  }

  /**
   * Get outline color for a color
   */
  static getTailwindOutlineColor(colorKey: ColorKey): string {
    const color = this.getColorDefinition(colorKey);
    return color.tailwind.outline;
  }

  /**
   * Get background color for a color
   */
  static getTailwindBgColor(colorKey: ColorKey): string {
    const color = this.getColorDefinition(colorKey);
    return color.tailwind.bg;
  }
   ...
   * Get text color for shape content
   */
  static getTailwindTextColor(colorKey: ColorKey): string {
    const color = this.getColorDefinition(colorKey);
    return color.tailwind.text;
  }
