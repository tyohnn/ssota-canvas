 ...
 * Dynamic Tool Part를 Task 컴포넌트로 렌더링
 *
 * Dynamic Tools:
 * - executeBlockAction: 블럭별 액션 실행
 *   (YouTube 스크립트 추출, PDF 요약 등)
 */
...
import type { DynamicToolPartProps } from './types';

export const AgentConversationDynamicToolPart = memo(
  function AgentConversationDynamicToolPart({ part }: DynamicToolPartProps) {
