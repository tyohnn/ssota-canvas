...
### 기능 완료
- [x] 이미지 블록 간소화 완료 (8개 항목) - 2025-12-08
- [x] objectFit이 항상 cover로 동작 - 2025-12-08
- [x] 이미지 업로드 시 종횡비 맞춤 블록 크기 설정 - 2025-12-08
- [x] 종횡비 고정 리사이저 동작 - 2025-12-08
- [x] 불필요한 툴바/액션 버튼 비활성화 - 2025-12-08
