...
- [ ] BlockAggregate 구현 (생성, 수정, 삭제 로직)
- [ ] Block Entity 구현
- [ ] BlockId, BlockType Value Objects 구현
- [ ] Commands 정의 (CreateBlock, UpdateBlock, DeleteBlock)
- [ ] Events 정의 (BlockCreated, BlockUpdated, BlockDeleted)
- [ ] BlockRepository 구현

#### Database
- [ ] blocks 테이블 생성 (Drizzle migration)
- [ ] block_type enum 생성
- [ ] RLS 정책 적용

#### Server Actions
- [ ] createBlockAction (블록 생성)
- [ ] updateBlockAction (블록 수정)
- [ ] deleteBlockAction (블록 삭제)
...
### Testing & Quality
- [ ] Unit Tests (BlockAggregate, Commands, Events)
- [ ] Integration Tests (Repository, Service)
- [ ] E2E Tests (블록 생성 전체 플로우)
...
### 기술 완료
- [ ] **Block Management Domain 단위 테스트** (BlockAggregate, Commands, Events)
- [ ] **Integration Tests** (Repository, Service)
- [ ] **E2E Tests** (블록 생성 전체 플로우)
- [ ] **코드 리뷰 완료**
...
## 📊 진행 상황
**현재**: 40% 완료 (Canvas Management 통합 완료, Block Management Domain 구현 필요)
...
### 🔄 Block Management Domain에서 구현 필요
- [ ] **BlockAggregate**: 블록 도메인 로직
- [ ] **Block Entity**: 블록 엔티티
- [ ] **Value Objects**: BlockId, BlockType
- [ ] **Commands & Events**: CreateBlock, UpdateBlock, DeleteBlock
- [ ] **BlockRepository**: 데이터베이스 접근
- [ ] **Server Actions**: createBlockAction, updateBlockAction, deleteBlockAction
...
- **도메인 의존성**: 
  ...
  - 🔄 **Block Management Domain**: 구현 필요 (이 스토리에서)
