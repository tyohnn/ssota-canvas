...
- [ ] OrganizationAggregate 구현
- [ ] CreateDefaultOrganizationCommand 정의
- [ ] DefaultOrganizationCreatedEvent 정의
...
### API & Server Action
- [ ] createDefaultOrganizationAction 구현
- [ ] 에러 처리 및 검증 로직
- [ ] 재시도 로직 구현
...
### 기능적 완료
- [ ] 신규 사용자 기본 조직 생성 정상 동작
- [ ] 기본 조직 중복 생성 방지 정상 동작
- [ ] 기본 조직 생성 실패 시 재시도 로직 동작
- [ ] 사용자가 조직 소유자로 설정됨
