...
### Story E010-003: 블록 추가 숏컷 (1pt)
**목표**: 동일 타입/속성 블록을 빠르게 추가하는 기능 구현  
**담당자**: Frontend Developer  
**예상 완료일**: 2025-12-05
...
**목표**: 에디터 패널을 블록 우측으로 이동  
**담당자**: Frontend Developer  
**예상 완료일**: 2025-12-06

### Story E010-006: 호버 시 회전 제거 (1pt)
**목표**: 마우스 호버 시 블록 회전 효과 제거  
**담당자**: Frontend Developer  
**예상 완료일**: 2025-12-05

### Story E010-007: 캔버스 상단 툴바 좌측 (1pt)
**목표**: 캔버스 상단 툴바를 좌측으로 이동  
**담당자**: Frontend Developer  
**예상 완료일**: 2025-12-06
...
### Story E010-009: 블록 선택 후 페이지 이동 (1pt)
**목표**: 블록 선택 후 해당 블록이 속한 페이지로 이동 기능  
**담당자**: Frontend Developer  
**예상 완료일**: 2025-12-09
