...
- ✅ 블록 간 간격은 상수로 정의 (TOP: 120px, BOTTOM: 120px, LEFT: 180px, RIGHT: 180px)
...
- [ ] **화요일 (12-10)**: 모든 작업 완료, 통합 테스트 완료

### 완료된 작업 (2025-12-08)
- ✅ E010-001: 이미지 블록 간소화 (8개 항목 모두 완료)
- ✅ E010-002: 엣지 핸들 숨기기 (호버 시 표시)
- ✅ E010-003: 블록 추가 + 버튼 (방향별 + 버튼으로 동일 블록 생성)
- ✅ E010-004: 블록 액션 위치 변경 (Position.Bottom)
- ✅ E010-005: 에디터 패널 위치 확인 (유지)
- ✅ E010-006: 호버 스케일 효과 제거
- ✅ E010-007: 캔버스 툴바 좌측 중앙 + 수직 배치
